...
class _BiteAndStingsScreenState extends State<BiteAndStingsScreen> {
  ...
  _createCall() {
    ...
    var questions = BitesAndStingsQuestions(patientAlert: _patientAlert, troubleBreathing: _troubleBreathing, troubleSwallowing:  _troubleSwallowing, tightnessThroatOrChest: _tightnessThroatOrChest, dizzyFaintOrSweaty: _dizzyFaintOrSweaty, pale: _pale, historyAllergicReactions: _historyAllergicReactions);
    _callsCubit.createUpdateCall(Call(id: const Uuid().v4(), patientId: _currentPatientId!, questionType: QuestionList.bitesAndStings.index, questions: questions, patient: Patient(id: "1o4Ne6GsML51CAUuqEmp", firstName: "John", lastName: "Doe", createdDate: Timestamp.now()), userId: null, createdDate: Timestamp.now()));
  }
            ...
            child: Column(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 10, left: 5, right: 5, bottom: 10),
                  child: SwitchListTile(
                    title: const Text('Does the patient have any trouble swallowing?'),
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 10, left: 5, right: 5, bottom: 10),
                  child: SwitchListTile(
                    title: const Text('Does the patient have any tightness in their throat or chest?'),
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 10, left: 5, right: 5, bottom: 10),
                  child: SwitchListTile(
                    title: const Text('Does the patient have any history of allergic reactions?'),
                ...
                ElevatedButton(
                  onPressed: () => _formKey.currentState!.validate() ? _createCall() : null,
